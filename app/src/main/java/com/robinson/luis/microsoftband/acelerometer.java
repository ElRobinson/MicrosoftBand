...
public class acelerometer extends AppCompatActivity {
    ...
    private BandAccelerometerEventListener mAccelerometerEventListener = new BandAccelerometerEventListener() {
        ...
        public void onBandAccelerometerChanged(final BandAccelerometerEvent event) {
            if (event != null) {
                float pegaX = event.getAccelerationX();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChart.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                while (txtInfo.length()!= 0){
                    stringao.append("x: " + posX + "\n" + "y: " + posY + "\n" + "z: " + posZ + "\n");
                }

                appendToUIGrafico(stringao.toString());
            }
        });
    }
    ...
    private void appendToUIGrafico(final String string) {
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    public void guardaGrafico(float x,float y,float z){
        ...
        posX.add(contTimer,x);
        posY.add(contTimer,y);
        posZ.add(contTimer,z);
        contTimer++;
    }
}
